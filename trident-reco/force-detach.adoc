...
NOTE: Você também pode usar métodos alternativos para detectar falha de nó, conforme especificado na link:force-detach.html#integrating-custom-node-health-check-solutions["Integrando soluções personalizadas de verificação de integridade de nós"] seção abaixo.

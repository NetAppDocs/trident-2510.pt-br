...
summary: Avisos legais fornecem acesso a declarações de direitos autorais, marcas registradas, patentes e mais. 
---
= Avisos legais
:allow-uri-read: 
:icons: font
...
Você pode consultar os direitos autorais e as licenças de terceiro usados no software NetApp para Trident no arquivo de avisos de cada versão em  https://github.com/NetApp/trident/[].

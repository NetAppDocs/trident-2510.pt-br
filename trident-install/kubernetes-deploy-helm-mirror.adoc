...
.Antes de começar
Além do link:../trident-install/kubernetes-deploy.html#before-you-deploy["pré-requisitos de deployment"] você precisa de link:https://v3.helm.sh/["Helm versão 3"^].

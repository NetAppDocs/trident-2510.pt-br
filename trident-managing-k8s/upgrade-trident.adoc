...
Geralmente, você deve atualizar usando o mesmo método que usou para a instalação inicial, porém você pode link:../trident-install/kubernetes-deploy.html#moving-between-installation-methods["alternar entre métodos de instalação"]. Existem duas opções para atualizar Trident.

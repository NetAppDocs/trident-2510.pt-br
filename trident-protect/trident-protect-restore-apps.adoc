...
+-------------+-----------+--------+-----------------+--------------------------+-------------+
----
. Restaure o aplicativo no cluster de destino usando o nome AppVault e o caminho do arquivo: OBSERVAÇÃO: ao usar uma CR, certifique-se de que o namespace destinado à restauração do aplicativo exista no cluster de destino.

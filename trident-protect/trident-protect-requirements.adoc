...
* Certifique-se de que exista pelo menos um VolumeSnapshotClass. Para obter mais informações, consulte link:../trident-reference/objects.html#kubernetes-volumesnapshotclass-objects["VolumeSnapshotClass"].

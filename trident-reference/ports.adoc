...
summary: Saiba mais sobre as portas que Trident utiliza para comunicação. 
---
= Portas Trident
:hardbreaks:
:allow-uri-read: 
...
NOTE: A porta de liveness/readiness pode ser alterada durante a instalação usando a flag  `--probe-port`. É importante garantir que essa porta não esteja sendo usada por outro processo nos nós de trabalho.

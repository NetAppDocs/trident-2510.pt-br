...
NOTE: Para autenticar usando uma função do AWS IAM, você deve ter um cluster Kubernetes implantado usando EKS.
...
----
Para obter mais informações, consulte link:https://docs.aws.amazon.com/eks/latest/userguide/pod-id-agent-setup.html["Configure o agente de identidade do Amazon EKS Pod"].
